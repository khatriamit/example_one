module example_one::restricted_transfer{
  ...
  /// An object that marks a property ownership. Can only be issued by
  /// an authority. 
  ...
  /// Create a 'TitleDeed' and transfer it to the property owner. 
  ...
  /// this function and pay a fee to 'LandRegistry'. 
  public entry fun transfer_ownership(
    ...
    // add a payement to the LandRegistry balance
